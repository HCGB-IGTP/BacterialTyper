...
htmlhelp_basename = 'BacterialTyperdoc'
...
latex_documents = [
    (master_doc, 'BacterialTyper.tex', 'BacterialTyper pipeline',
     author, 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'BacterialTyper', 'BacterialTyper pipeline documentation',
    author, 'BacterialTyper', 'Brief description','Miscellaneous')
]
