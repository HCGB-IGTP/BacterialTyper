...
def run_database(options):
    ...
    """Main function of the database module.
    
    It controls, downloads and updates each database required for BacterialTyper modules.
    
    
    .. seealso:: This function depends on other BacterialTyper and HCGB functions called:
    
        - :func:`BacterialTyper.scripts.BUSCO_caller`
    ...
    if (options.no_ARIBA):
        ...
        if (options.ariba_users_fasta):
            ...
            if Debug:
                ...
                print (options.ariba_users_fasta)
