...
def check_sample_assembly(name, sample_folder, files, threads):
	...
	It checks wether a sample is assembled or not by reading file *sample_folder/.success_all* (generated by :func:`BacterialTyper.scripts.functions.print_time_stamp`). 
